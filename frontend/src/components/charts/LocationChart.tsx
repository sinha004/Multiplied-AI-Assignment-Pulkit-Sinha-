...
export function LocationChart({ data, loading }: LocationChartProps) {
    ...
    series: [
      {
        ...
        data: sortedData.map((item, index) => ({
          value: item.value,
          itemStyle: {
            color: chartColors.palette[(index + 2) % chartColors.palette.length],
  ...
  return (
    <div className="card" style={{ height: '300px' }}>
      <h3 className="text-lg font-semibold text-gray-800 mb-4 px-4 pt-4">Location</h3>
